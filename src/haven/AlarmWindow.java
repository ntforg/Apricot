...
public class AlarmWindow extends Window {
	...
	public AlarmWindow() {
		...
		dontTriggerCheckboxLabel.tooltip = dontTriggerCheckboxLabel2.tooltip = L10N.richtip("This checkbox only affects entities that can be knocked out or dead (for example, animals).", UI.scale(300));
		...
		alarmNameLabel2.tooltip = L10N.richtip("You can set this to whatever you want, or even leave empty. It's here just to help you find your alarms easier in the list.", UI.scale(300));
		Label resPathLabel2;
		prev = add(resPathLabel2 = new Label("Resource Path"), prev.pos("ul").adds(170, 0));
		resPathLabel2.tooltip = L10N.richtip("This is the resource path of the entity type for which you want to throw an alarm.\n$col[200,0,0]{Note: This field can not be changed after the alarm has been added!}", UI.scale(300));
		Label soundFileLabel2;
		prev = add(soundFileLabel2 = new Label("Sound File"), prev.pos("ul").adds(180, 0));
		soundFileLabel2.tooltip = L10N.richtip("This is the name of the .wav sound file that will be played when the alarm is triggered.\nThe file must be present in the \"AlarmSounds\" folder.\n$col[185,185,185]{You don't need to include the file extension in this box, but it must always be a .wav file!}", UI.scale(300));
		prev = add(new Label("Volume"), prev.pos("ul").adds(120, 0));
		...
		dontTriggerCheckboxLabel0.tooltip = dontTriggerCheckboxLabel02.tooltip = L10N.richtip("This checkbox only affects entities that can be knocked out or dead (for example, animals).", UI.scale(300));
