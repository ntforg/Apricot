...
public class CheckpointManager extends Window implements Runnable {
    ...
    public CheckpointManager(GameUI gui) {
        ...
        transformIntoArea.tooltip = L10N.richtip("If you want to scan a specific area on the map, draw a polygon with checkpoints, then press this button to convert it before starting.", UI.scale(350));
        ...
        resizeButton.tooltip = L10N.richtip("Show Routes Manager", UI.scale(350));
        ...
        reverseButton.tooltip = L10N.richtip("Reverse path.", UI.scale(350));
    }
    ...
    public void toggleExtendWindow() {
        ...
        if (extendedView) {
            ...
            resizeButton.tooltip = L10N.richtip("Hide Routes Manager", UI.scale(350));
